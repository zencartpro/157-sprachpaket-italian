 ...
 * @version $Id: orders.php 2024-05-14 11:49:16Z webchills $
 */
...
define('EMAIL_TEXT_SUBJECT', 'Stato dell\'ordine aggiornato');
define('EMAIL_TEXT_ORDER_CUSTOMER_GENDER_MALE', 'Caro Sig. ');
define('EMAIL_TEXT_ORDER_CUSTOMER_GENDER_FEMALE', 'Cara signora ');
define('EMAIL_TEXT_ORDER_CUSTOMER_NEUTRAL', 'Buongiorno ');
define('EMAIL_TEXT_UPDATEINFO', 'Vi informeremo sullo stato del vostro ordine a ');
...
define('EMAIL_TEXT_COMMENTS_UPDATE', '<strong>Nota:</strong> ' . "\n\n");
define('EMAIL_TEXT_STATUS_UPDATED', 'Lo stato dell\'ordine è stato aggiornato.' . "\n\n");
define('EMAIL_TEXT_STATUS_LABEL', '<strong>Nuovo stato:</strong> %s' . "\n\n");
define('EMAIL_TEXT_STATUS_PLEASE_REPLY', 'Per qualsiasi domanda, si prega di contattare questo indirizzo e-mail <a href="mailto:' . STORE_OWNER_EMAIL_ADDRESS . '">' . STORE_OWNER_EMAIL_ADDRESS . '</a>.<br>' . "\n");
