...
define('EMAIL_EC_ACCOUNT_INFORMATION', 'Al momento del checkout con PayPal Express viene automaticamente creato un conto cliente presso il nostro negozio, così potrai riaccedere per controllare lo stato dell\'ordine. Per accedere al conto cliente utilizza i dati seguenti:');
