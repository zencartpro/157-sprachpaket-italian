...
define('MODULE_SHIPPING_STOREPICKUP_TEXT_TITLE', 'Raccolta autonoma');
define('MODULE_SHIPPING_STOREPICKUP_TEXT_DESCRIPTION', 'Raccolta autonoma');
define('MODULE_SHIPPING_STOREPICKUP_TEXT_WAY', 'Ritirate la merce da noi');
