...
define('ERROR_GV_CREATE_ACCOUNT', 'Per riscattare un buono regalo devi creare un account.');
define('ERROR_GV_COWOA', 'Per riscattare un buono regalo devi creare un account. Non è possibile inserire un buono regalo dopo aver effettuato il check-out senza un account. Se desideri utilizzare un buono regalo, puoi fare <a href="' . zen_href_link(FILENAME_LOGOFF, '', 'SSL', false) . '">clic qui</a> per terminare la sessione, svuotare il carrello e ricominciare.');
?>