...
define('BUTTON_DROPSHIPPING_ALT', 'Ordine speciale');
define('BUTTON_DROPSHIPPING_SMALL_ALT', 'Ordine speciale');
...
define('BUTTON_ASK_A_QUESTION_ALT', 'Domanda sull\'articolo');
