 ...
 * @version $Id: orders_status_updates.php 2024-05-14 08:39:16Z webchills $
 */
define('OSH_EMAIL_SEPARATOR', '------------------------------------------------------');
define('OSH_EMAIL_TEXT_SUBJECT', 'Aggiornamento dell\'ordine');
...
define('OSH_EMAIL_TEXT_COMMENTS_UPDATE', '<em>Commenti sull\'ordine: </em>');
define('OSH_EMAIL_TEXT_STATUS_UPDATED', 'Lo stato dell\'ordine è stato aggiornato:' . "\n");
define('OSH_EMAIL_TEXT_STATUS_NO_CHANGE', 'Lo stato dell\'ordine non è cambiato:' . "\n");
define('OSH_EMAIL_TEXT_STATUS_LABEL', '<strong>Stato attuale: </strong> %s' . "\n\n");
define('OSH_EMAIL_TEXT_STATUS_CHANGE', '<strong>Vecchio stato:</strong> %1$s, <strong>Nuovo stato:</strong> %2$s' . "\n\n");
